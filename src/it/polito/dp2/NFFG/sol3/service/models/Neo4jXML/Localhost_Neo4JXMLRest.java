...
}, comments = "wadl2java, http://wadl.java.net", date = "2017-01-16T23:58:11.844+01:00")
public class Localhost_Neo4JXMLRest {
    ...
    public static class Resource {
        ...
        public Localhost_Neo4JXMLRest.Resource.NodeNodeId2 nodeNodeId2(String nodeid) {
            return new Localhost_Neo4JXMLRest.Resource.NodeNodeId2(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nodeid);
        }
        ...
        public static class Node {
            ...
            public it.polito.dp2.NFFG.sol3.service.models.Neo4jXML.Node postXmlAsNode(it.polito.dp2.NFFG.sol3.service.models.Neo4jXML.Node input) {
                ...
                return response.getEntity(it.polito.dp2.NFFG.sol3.service.models.Neo4jXML.Node.class);
            }
        ...
        public static class NodeNodeid {
            ...
            public it.polito.dp2.NFFG.sol3.service.models.Neo4jXML.Node getAsNode() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
        ...
        public static class NodeNodeId2 {

            private Client _client;
            private UriBuilder _uriBuilder;
            private Map<String, Object> _templateAndMatrixParameterValues;

            private NodeNodeId2(Client client, UriBuilder uriBuilder, Map<String, Object> map) {
                _client = client;
                _uriBuilder = uriBuilder.clone();
                _templateAndMatrixParameterValues = map;
            }
             ...
             * 
             */
            public NodeNodeId2(Client client, URI baseUri, String nodeid) {
                _client = client;
                _uriBuilder = UriBuilder.fromUri(baseUri);
                _uriBuilder = _uriBuilder.path("/node/{nodeId}");
                _templateAndMatrixParameterValues = new HashMap<String, Object>();
             ...
             * 
             */
            public NodeNodeId2(Client client, URI uri) {
                _client = client;
                StringBuilder template = new StringBuilder(BASE_URI.toString());
                if (template.charAt((template.length()- 1))!= '/') {
                    template.append("/resource/node/{nodeId}");
             ...
             * 
             */
            public Localhost_Neo4JXMLRest.Resource.NodeNodeId2 setNodeid(String nodeid) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("nodeId", nodeid);
                return new Localhost_Neo4JXMLRest.Resource.NodeNodeId2(_client, copyUriBuilder, copyMap);
            }
        ...
        public static class NodeNodeidRelationship {
            ...
            public it.polito.dp2.NFFG.sol3.service.models.Neo4jXML.Relationship postXmlAsRelationship(it.polito.dp2.NFFG.sol3.service.models.Neo4jXML.Relationship input) {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(it.polito.dp2.NFFG.sol3.service.models.Neo4jXML.Relationship.class);
            }
        ...
        public static class Nodes {
            ...
            public it.polito.dp2.NFFG.sol3.service.models.Neo4jXML.Nodes getAsNodes() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(it.polito.dp2.NFFG.sol3.service.models.Neo4jXML.Nodes.class);
            }
        ...
        public static class RelationshipRelationshipid {
            ...
            public it.polito.dp2.NFFG.sol3.service.models.Neo4jXML.Relationship getAsRelationship() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
